...
export interface Constantes {
  ...
  PayLive: PayData;
  PayQC: PayData;
  [key: string]: DatosVar | DatosRail | PayData; // index signature for ObtenerDatos lookup
}
...
export const { datosvar, PayQC, PayLive } = constantes;
