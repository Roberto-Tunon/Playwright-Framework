...
test('Lutz Regression with Credit Card', async ({ browser }) => {
    ...
    console.log(`Parámetro recibido: ${rail},${datosvar.Branch}`);
    
    await page.goto(`https://branch-${datosvar.Branch}-xxxlutz-${rail}.qc.xxxl-dev.at/`);   
